...
This is the privacy policy for the **ScriptStar**, macOS Application that is available on the macOS App Store and TestFlight.

**ScriptStar** does not collect any user data. No personal information is transmitted, stored, or used by this application.

**ScriptStar** does not use any third-party analytics or tracking tools. It does not contain any in-app purchases or advertisements.
...
If you have any questions or concerns, you can [submit an issue](https://github.com/latenitefilms/ScriptStar/issues), or email us: support@latenitefilms.com